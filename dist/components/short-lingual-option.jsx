...
const ShortLingualOption = (_a) => {
    ...
    return <input type="text" value={interactionToken.interactionValue} onChange={handleChange} {...inline ? { 'data-inline': true } : {}} {...node.defaultValue ? { defaultValue: node.value } : { placeholder: node.value }} {...props}/>;
};
